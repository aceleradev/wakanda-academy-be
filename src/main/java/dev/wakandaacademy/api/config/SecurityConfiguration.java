...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		...
		.authorizeRequests().antMatchers("/authenticate", "/authenticate/", "/public/**", "/authenticate/refresh*", "/v2/api-docs", "/configuration/ui", "/swagger-resources/**", "/configuration/**", "/swagger-ui.html", "/webjars/**", "/user", "/user/").permitAll()
